...
def minimax(board):
    ...
    # case of player is x (max-player)
        ...
        for action in actions(board):
            # add in plays list a tupple with the min_value and the action that result to its value
            plays.append(min_value(result(board, action)),action)
        # Reverce sort for the plays list and get the action that should take
